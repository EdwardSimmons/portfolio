...
<template>
  <content-card>
    ...
    <div class="app-links">
      ...
      >
        <template #image>
          <mobile-app-icon :img="app.icon" class="tw-mr-2" />
        </template>
